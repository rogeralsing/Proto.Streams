...
namespace Proto.Streams.Implementation
{
    ...
    public abstract class ExtendedActorMaterializer : ActorMaterializer
    {
        ...
        {
            return ActorOf(props, context.StageName);
        }
    ...
    public sealed class ActorMaterializerImpl : ExtendedActorMaterializer
    {
        ...
        /// <returns>TBD</returns>
        public ActorMaterializerImpl(ActorSystem system, ActorMaterializerSettings settings, IActorRef supervisor, AtomicBoolean haveShutDown, EnumerableActorName flowNames)
        {
            _system       = system;
            _settings     = settings;
    ...
    public class FlowNameCounter : ExtensionIdProvider<FlowNameCounter>, IExtension
    {
        ...
        /// <param name="system">TBD</param>
        /// <returns>TBD</returns>
        public override FlowNameCounter CreateExtension(ActorSystem system) => new FlowNameCounter();
    }
    ...
    public class StreamSupervisor : ActorBase
    {
        ...
        /// </summary>
        /// <returns>TBD</returns>
        protected override ISupervisorStrategy SupervisorStrategy() => Actor.SupervisorStrategy.StoppingStrategy;
