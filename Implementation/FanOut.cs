...
namespace Proto.Streams.Implementation
{
    ...
    internal static class Unzip
    {
        ...
        public static Props Props<T>(ActorMaterializerSettings settings)
            => Proto.Props.FromProducer(() => new Unzip<T>(settings, 2));
    }
    ...
    internal sealed class Unzip<T> : FanOut<T>
    {
        ...
        /// This exception is thrown when the elements in <see cref="Proto.Streams.Implementation.FanOut{T}.PrimaryInputs"/>
