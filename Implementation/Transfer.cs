...
namespace Proto.Streams.Implementation
{
    ...
    {
        private StageActorRef.Receive _currentReceive;

        /// <summary>
        /// TBD
        /// </summary>
        /// <param name="initial">TBD</param>
        public SubReceive(StageActorRef.Receive initial)
        {
        ...
        /// TBD
        /// </summary>
        public StageActorRef.Receive CurrentReceive => _currentReceive;

        /// <summary>
        /// TBD
        /// </summary>
        /// <param name="receive">TBD</param>
        public void Become(StageActorRef.Receive receive) => _currentReceive = receive;
    }
