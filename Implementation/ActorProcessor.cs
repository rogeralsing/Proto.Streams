...
namespace Proto.Streams.Implementation
{
    ...
    internal abstract class ActorProcessorImpl : ActorBase, IPump
    {
        ...
        private sealed class InternalExposedPublisherReceive : ExposedPublisherReceive
        {
            ...
            public InternalExposedPublisherReceive(StageActorRef.Receive activeReceive, Action<object> unhandled, ActorProcessorImpl self) : base(activeReceive, unhandled)
            {
                _self = self;
            }
