...
using static Proto.Streams.Implementation.Fusing.GraphInterpreter;
...
#pragma warning restore CS0162
        ...
        /// <param name="shell">TBD</param>
        /// <returns>TBD</returns>
        public static Props Props(GraphInterpreterShell shell) => Proto.Props.FromProducer(() => new ActorGraphInterpreter(shell)).WithDeploy(Deploy.Local);
