...
namespace Proto.Streams
{
    ...
    public sealed class Attributes
    {
        ...
        public sealed class LogLevels : IAttribute, IEquatable<LogLevels>
        {
            ...
            /// </summary>
            public static readonly LogLevel Off = LogLevel.None;
        ...
        /// <returns>TBD</returns>
        public static Attributes CreateLogLevels(LogLevel onElement = LogLevel.Debug,
            LogLevel onFinish = LogLevel.Debug, LogLevel onError = LogLevel.Error)
