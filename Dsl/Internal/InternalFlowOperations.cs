...
namespace Proto.Streams.Dsl.Internal
{
    ...
    internal static class InternalFlowOperations
    {
        ...
        /// 
        /// If the group by function <paramref name="asyncMapper"/> throws an exception or if the <see cref="Task"/> is completed
        /// with failure and the supervision decision is <see cref="ActorGraphInterpreter.Resume"/> or
        ...
        /// 
        /// If the function <paramref name="scan"/> throws an exception and the supervision decision is
        /// <see cref="ActorGraphInterpreter.Resume"/> current value starts at the previous
        ...
        /// subscriber.
        /// 
        /// Expand does not support <see cref="Restart"/> and <see cref="ActorGraphInterpreter.Resume"/>.
        ...
        /// is <see cref="ActorGraphInterpreter.Resume"/> or <see cref="Restart"/>
