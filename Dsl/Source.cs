...
using Proto.Streams.Implementation.Fusing;
using Proto.Streams.Implementation.Stages;
using Proto.Streams.Supervision;
using Proto.Streams.Util;
using Proto.Util;
using Proto;
...
namespace Proto.Streams.Dsl
{
    ...
    public static class Source
    {
        ...
        /// created according to the passed in <see cref="Proto.Props"/>. Actor created by the <see cref="Proto.Props"/> must
        /// be <see cref="ActorPublisher"/>.
        /// </summary>
        /// <typeparam name="T">TBD</typeparam>
        /// <param name="props">TBD</param>
        /// <exception cref="ArgumentException">
        /// This exception is thrown when the specified actor <paramref name="props"/> is not of type <see cref="ActorPublisher"/>.
        /// </exception>
        /// <returns>TBD</returns>
        ...
        /// </para>
        /// <para>
        /// <see cref="Directive.Restart"/> supervision strategy will close and create blocking IO again. Default strategy is <see cref="Directive.Stop"/> which means
        ...
        /// </para>
        /// <para>
        /// <see cref="Directive.Restart"/> supervision strategy will close and create resource .Default strategy is <see cref="Directive.Stop"/> which means
