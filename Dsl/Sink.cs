...
namespace Proto.Streams.Dsl
{
    ...
    public static class Sink
    {
        ...
        /// <see cref="Proto.Stop"/> the <see cref="Task"/> will be completed with failure.
        /// 
        /// If the action throws an exception and the supervision decision is
        /// <see cref="ActorGraphInterpreter.Resume"/> or <see cref="Proto.Restart"/> the
        ...
        /// created according to the passed in <see cref="Proto.Props"/>. Actor created by the <paramref name="props"/> should
        ...
        /// </para>
        /// <para>
        /// If <paramref name="sinkFactory"/> throws an exception and the supervision decision is <see cref="Directive.Stop"/> 
