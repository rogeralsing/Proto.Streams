...
using Proto.Streams.Dsl.Internal;
using Proto.Streams.Implementation;
using Proto.Streams.Stage;
using Proto.Streams.Supervision;
using Proto.Util;
using Proto;
using Reactive.Streams;
using Decider = Proto.Streams.Supervision.Decider;
...
namespace Proto.Streams
{
    ...
    {
        private static readonly Config DefaultMaterializerConfig = ConfigurationFactory.FromResource<ActorMaterializer>("Proto.Streams.reference.conf");
        ...
        /// pipeline within its own <see cref="Proto.ActorBase"/>. The required <see cref="IActorRefFactory"/>
        /// (which can be either an <see cref="ActorSystem"/> or an <see cref="IActorContext"/>)
        /// will be used to create one actor that in turn creates actors for the transformation steps.
        /// </para>
        /// <para>
        /// The materializer's <see cref="Proto.Streams.ActorMaterializerSettings"/> will be obtained from the
    ...
    internal static class ActorMaterializerHelper
    {
        ...
        /// <exception cref="ArgumentException">
        /// This exception is thrown when the specified <paramref name="materializer"/> is not of type <see cref="Proto.Streams.ActorMaterializer"/>.
        /// </exception>
        /// <returns>TBD</returns>
    ...
    public class AbruptTerminationException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Proto.Streams.AbruptTerminationException" /> class.
        /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Proto.Streams.MaterializationException"/> class.
        /// </summary>
    ...
    public sealed class AbruptStageTerminationException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Proto.Streams.AbruptStageTerminationException"/> class.
        /// </summary>
        /// <param name="info">The <see cref="SerializationInfo" /> that holds the serialized object data about the exception being thrown.</param>
        /// <param name="context">The <see cref="StreamingContext" /> that contains contextual information about the source or destination.</param>
    ...
    /// <summary>
    /// This class describes the configurable properties of the <see cref="Proto.Streams.ActorMaterializer"/>. 
    ...
    public sealed class ActorMaterializerSettings
    {
        ...
        /// stream topology by using <see cref="Proto.Streams.Attributes.InputBuffer"/>.
        /// </summary>
        ...
        /// with the <see cref="Proto.Streams.ActorMaterializer"/>. This can be overridden for individual parts of the
        /// stream topology by using <see cref="Proto.Streams.ActorAttributes.Dispatcher"/>.
        /// </summary>
        /// <param name="dispatcher">TBD</param>
        /// <returns>TBD</returns>
        ...
        /// <see cref="Proto.Streams.ActorAttributes.SupervisionStrategy"/>
        /// </summary>
        ...
        /// deadline, configured by <see cref="Proto.Streams.StreamSubscriptionTimeoutSettings"/>.
        /// </summary>
        /// <param name="settings">TBD</param>
        /// <returns>TBD</returns>
    ...
    /// <summary>
    /// Leaked publishers and subscribers are cleaned up when they are not used within a given deadline, configured by <see cref="Proto.Streams.StreamSubscriptionTimeoutSettings"/>.
    /// </summary>
